...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    restaurant_resources_common_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get('restaurant/get_menu_list' + add_restaurant_id).then(function (response) {
    ...
    _c(
      ...
      [
        _c(
          ...
          [
            _c("router-link", { attrs: { to: "add_menu" } }, [
