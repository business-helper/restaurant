...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    api_service.get('restaurant/category_list' + add_restaurant_id).then(function (response) {
      _this.tableData = response.data.data;

      _this.tableData.forEach(function (item, index) {
        _this.$set(item, "action", "<a class='clickable edit' href='#/edit_category/".concat(item.id).concat(add_restaurant_id, "'><i class='fas fa-edit'></i> </a>\n                    <a class='clickable delete' href=\"javascript:void(0)\"><i class='fas fa-trash' action=\"delete\" target_id=\"").concat(item.id, "\"></i> </a>"));
    ...
    action: function action(newVal) {
      ...
      if (newVal.id != null) {
        ...
        if (id && action) {
          ...
          api_service.get("restaurant/delete_category/".concat(id)).then(function (response) {
