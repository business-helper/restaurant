...
1. Include the stylesheet on your document's `<head>`
  ...
  ```
  or use the version hosted by [CDNJS](//cdnjs.com/libraries/animate.css)
  ```html
  <head>
...
[Check out all the animations here!](//daneden.github.io/animate.css/)
...
[View a video tutorial](//www.youtube.com/watch?v=CBQGl6zokMs) on how to use Animate.css with jQuery here.
