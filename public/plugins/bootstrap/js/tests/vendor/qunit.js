...
// See also //developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Error/Stack
	...
	module: function( name, testEnvironment, executeNow ) {
		...
		if ( testEnvironment && ( testEnvironment.setup || testEnvironment.teardown ) ) {
			console.warn(
				...
				"Details in our upgrade guide at //qunitjs.com/upgrade-guide-2.x/"
			);
		}
 ...
 * (//code.google.com/p/google-diff-match-patch/source/browse/trunk/javascript/diff_match_patch_uncompressed.js),
...
QUnit.diff = ( function() {
	...
	DiffMatchPatch.prototype.diffCommonPrefix = function( text1, text2 ) {
		...
		// Binary search.
		// Performance analysis: //neil.fraser.name/news/2007/10/09/
		pointermin = 0;
	...
	DiffMatchPatch.prototype.diffCommonOverlap = function( text1, text2 ) {
		...
		// Performance analysis: //neil.fraser.name/news/2010/11/04/
		best = 0;
		length = 1;
		while ( true ) {
