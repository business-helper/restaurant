...
Using [bower](//github.com/twitter/bower):
```bash
...
If you want the latest stable version, get the latest release from the [releases page](//github.com/flesler/jquery.localScroll/releases).
