[![Build Status](//secure.travis-ci.org/Prinzhorn/skrollr.png)](http://travis-ci.org/Prinzhorn/skrollr)
...
* [skrollr-menu](//github.com/Prinzhorn/skrollr-menu) - Hash navigation
* [skrollr-ie](//github.com/Prinzhorn/skrollr-ie) - IE < 9 CSS fixes
* [skrollr-stylesheets](//github.com/Prinzhorn/skrollr-stylesheets) - Keyframes inside CSS files

### Third party

* [skrollr-colors](//github.com/FezVrasta/skrollr-colors) - Mix and match hex, rgb and hsl colors.

In the wild
-----

Check out the [wiki page](//github.com/Prinzhorn/skrollr/wiki/In-the-wild) for websites using skrollr and feel free to add your own website :). You can also shamelessly add yourself to the list [here](//github.com/Prinzhorn/skrollr/wiki/Agencies-and-freelancers) if you are offering paid skrollr support.

Further resources (tutorials etc.)
-----

Moved to the [wiki](//github.com/Prinzhorn/skrollr/wiki/Resources).


Documentation
=====

First of all: look at the [examples and read the source ;-)](//github.com/Prinzhorn/skrollr/tree/master/examples). This might give you a feeling of how stuff works and you can see how some patterns can be implemented.
...
If you would rather have the keyframes inside a separate file, take a look at [skrollr-stylesheets](//github.com/Prinzhorn/skrollr-stylesheets).
...
If you're not a fan of `data-attributes` or if you're planning a big website where you want a better and more flexible structure, take a look at [skrollr-stylesheets](//github.com/Prinzhorn/skrollr-stylesheets).
...
[![Anchors Guide](//raw.github.com/Prinzhorn/skrollr/master/guide/anchor-position-guide.png)](//raw.github.com/Prinzhorn/skrollr/master/guide/anchor-position-guide.pdf)
...
Check out the [skrollr-menu](//github.com/Prinzhorn/skrollr-menu) plugin.
...
* outCubic
* bounce: Bounces like a ball. See //www.desmos.com/calculator/tbr20s8vd2 for a graphical representation.
...
See [HISTORY.md](//github.com/Prinzhorn/skrollr/blob/master/HISTORY.md).
