...
[![GitHub
version](//badge.fury.io/gh/HubSpot%2Ftether.svg)](http://badge.fury.io/gh/HubSpot%2Ftether)
...
Or just download from the [releases](//github.com/HubSpot/tether/releases).

## Usage
You only need to include [tether.min.js](//github.com/HubSpot/tether/blob/master/dist/js/tether.min.js) in your page:
```
...
The css files in the [dist/css](//github.com/HubSpot/tether/tree/master/dist/css) folder are not required to get tether running.
