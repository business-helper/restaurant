        ...
        <vue-form class="form-horizontal form-validation" :state="formstate" @submit.prevent="onSubmit">
            ...
            <div class="logo-image-part-holder">
                <div class="image-base-holder">
                    ...
                    <clipper-basic  class="logo-image-origin" ref="clipper" :src="model.imageURL" shadow="rgba(0,0,0,0.4)" @load="imgLoad" :ratio="1.43">
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            this.model.offer_id=this.$route.params.offer_id;
            ApiService.get(`admin/get_offer/${this.model.offer_id}`).then(response => {
