<template>
    <div class="row">
        <div class="col-lg-12">
            <b-card header="Add Employee" header-tag="h4" class="bg-success-card">
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12 col-12 mt-4">
                                        <div class="form-group">
                                            <label>Profile Picture</label>
                                            <image-input v-model="model.profile_picture"></image-input>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <select id="location" name="location" size="1" class="form-control" v-model="model.location_id" checkbox>
                                                    ...
                                                    <option v-for="location in locations" :value="location.id">{{location.restaurant_name}}</option>
                                                </select>
                                            </validate>
                                        </div>
                                    </div>
...
<script>
   ...
   import ImageInput from 'pages/ImageInput';
    ...
    export default {
        ...
        methods: {
            onSubmit: function () {
                if (this.formstate.$invalid) {
                    ...
                    ApiService.post('employee/register', this.model)
                        .then(data => {
        ...
        beforeMount(){
            ApiService.get('admin/get_location')
                .then(
                    response => {
