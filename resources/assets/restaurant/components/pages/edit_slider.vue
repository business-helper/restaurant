        ...
        <vue-form class="form-horizontal form-validation" :state="formstate" @submit.prevent="onSubmit">
            ...
            <div class="row">
                <div class="col-8 col-md-6">
                    <div class="form-group">
                        ...
                        <select v-model="model.menu_index" class="form-control" name="menu_index" required autofocus @click="loaded=1">
            ...
            <div class="logo-image-part-holder">
                <div class="image-base-holder">
                    ...
                    <clipper-basic  class="logo-image-origin" ref="clipper" :src="model.imageURL" shadow="rgba(0,0,0,0.4)" :ratio="2.18" @load="imgLoad">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit(){
                ...
                this.getResult();
                ApiService.post('admin/update_slider', this.model).
                    then(
                        result => {
                            console.log(result)
        ...
        beforeMount() {
            ...
            ApiService.get(`admin/get_slider/${this.model.slider_id}`).then(response => {
                    let data=response.data;
                    this.menus = data.menu;
                    let slider=data.slider;
                    this.model.menu_index=slider.menu_index;
                    this.model.menu_name=slider.menu_name;
                    this.model.description=slider.description;
                    this.model.order=slider.order;
                    this.model.slider_type=slider.type;
                    fetch(slider.image)
