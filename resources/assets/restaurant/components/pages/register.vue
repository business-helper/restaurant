                            ...
                            <div class="form-group">
                                <validate tag="div">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input v-model="model.phone_number" id="phone_number" name="phone_number" type="text"
                                               required autofocus placeholder="Phone Number" class="form-control"/>
                                    </div>
                                </validate>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <validate tag="div">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input id="profile_picture" v-on:change="onImageChange" name="profile_picture" type="file"
                            ...
                            <div class="form-group">
                                <validate tag="div">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input v-model="model.password_confirmation" name="password_confirmation" id="confirm_password"
        ...
        methods: {
            ...
            onSubmit: function () {
                if (this.formstate.$invalid) {
                    ...
                    ApiService.post('restaurant/register',this.model)
                        .then(data => {
                            console.log(data);
                            if (!data.data.error)  // if there is no error
                            {
                                ...
                                this.$store.commit('changeUser',user_data.user);
